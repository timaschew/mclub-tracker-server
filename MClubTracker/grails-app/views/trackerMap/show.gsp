...
<html>
    ...
    <body>
        ...
        <div id="show-trackerMap" class="content scaffold-show" role="main">
            ...
            <f:display bean="trackerMap" />
            <g:form resource="${this.trackerMap}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.trackerMap}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
