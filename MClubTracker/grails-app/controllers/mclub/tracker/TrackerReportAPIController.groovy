...
class TrackerReportAPIController {
    ...
    def daily_positions() {
        ...
        def results = trackerReportService.listDevicePositionOfDay(deviceUniqueId, date)
                .collect{ p->
    ...
    def daily_tracks(){
        ...
        def tracks = trackerReportService.listTracksBetweenDays(deviceUniqueId, begin, end);
